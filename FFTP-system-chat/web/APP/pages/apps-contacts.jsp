                        ...
                        <ul class="nav flex-column custom-scrollbar" id="sidenav" data-children=".nav-item">
                            ...
                            <li class="nav-item" role="tab" id="heading-dashboards">
                                ...
                                <ul id="collapse-dashboards" class='collapse ' role="tabpanel" aria-labelledby="heading-dashboards" data-children=".nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="index.html" data-url="apps-contacts.html">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="apps-dashboards-server.html" data-url="apps-contacts.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link ripple " href="apps-calendar.html" data-url="apps-contacts.html">
                            ...
                            <li class="nav-item" role="tab" id="heading-ecommerce">
                                ...
                                <ul id="collapse-ecommerce" class='collapse ' role="tabpanel" aria-labelledby="heading-ecommerce" data-children=".nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="apps-e-commerce-products.html" data-url="apps-contacts.html">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="apps-e-commerce-product.html" data-url="apps-contacts.html">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="apps-e-commerce-orders.html" data-url="apps-contacts.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link ripple " href="apps-mail.html" data-url="apps-contacts.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link ripple " href="apps-chat.html" data-url="apps-contacts.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link ripple " href="apps-file-manager.html" data-url="apps-contacts.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link ripple active" href="apps-contacts.html" data-url="apps-contacts.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link ripple " href="apps-todo.html" data-url="apps-contacts.html">
                            ...
                            <li class="nav-item" role="tab" id="heading-authentication">
                                ...
                                <ul id="collapse-authentication" class='collapse ' role="tabpanel" aria-labelledby="heading-authentication" data-children=".nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="pages-auth-login.html" data-url="apps-contacts.html">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="pages-auth-login-v2.html" data-url="apps-contacts.html">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="pages-auth-register.html" data-url="apps-contacts.html">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="pages-auth-register-v2.html" data-url="apps-contacts.html">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="pages-auth-forgot-password.html" data-url="apps-contacts.html">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="pages-auth-reset-password.html" data-url="apps-contacts.html">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="pages-auth-lock-screen.html" data-url="apps-contacts.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link ripple " href="pages-coming-soon.html" data-url="apps-contacts.html">
                            ...
                            <li class="nav-item" role="tab" id="heading-errors">
                                ...
                                <ul id="collapse-errors" class='collapse ' role="tabpanel" aria-labelledby="heading-errors" data-children=".nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="pages-errors-404.html" data-url="apps-contacts.html">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="pages-errors-500.html" data-url="apps-contacts.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link ripple " href="pages-maintenance.html" data-url="apps-contacts.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link ripple " href="pages-profile.html" data-url="apps-contacts.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link ripple " href="pages-search.html" data-url="apps-contacts.html">
                            ...
                            <li class="nav-item" role="tab" id="heading-elements">
                                ...
                                <ul id="collapse-elements" class='collapse ' role="tabpanel" aria-labelledby="heading-elements" data-children=".nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="user-interface-elements-alerts.html" data-url="apps-contacts.html">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="user-interface-elements-badges.html" data-url="apps-contacts.html">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="user-interface-elements-breadcrumb.html" data-url="apps-contacts.html">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="user-interface-elements-buttons.html" data-url="apps-contacts.html">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="user-interface-elements-button-group.html" data-url="apps-contacts.html">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="user-interface-elements-cards.html" data-url="apps-contacts.html">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="user-interface-elements-dropdowns.html" data-url="apps-contacts.html">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="user-interface-elements-forms.html" data-url="apps-contacts.html">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="user-interface-elements-input-group.html" data-url="apps-contacts.html">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="user-interface-elements-jumbotron.html" data-url="apps-contacts.html">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="user-interface-elements-list-group.html" data-url="apps-contacts.html">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="user-interface-elements-navs.html" data-url="apps-contacts.html">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="user-interface-elements-navbar.html" data-url="apps-contacts.html">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="user-interface-elements-pagination.html" data-url="apps-contacts.html">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="user-interface-elements-progress.html" data-url="apps-contacts.html">
                            ...
                            <li class="nav-item" role="tab" id="heading-tables">
                                ...
                                <ul id="collapse-tables" class='collapse ' role="tabpanel" aria-labelledby="heading-tables" data-children=".nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="user-interface-tables-simple-table.html" data-url="apps-contacts.html">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="user-interface-tables-data-table.html" data-url="apps-contacts.html">
                                ...
                                <ul id="collapse-page-layouts" class='collapse ' role="tabpanel" aria-labelledby="heading-page-layouts" data-children=".nav-item">
                                    ...
                                    <li class="nav-item" role="tab" id="heading-carded">
                                        ...
                                        <ul id="collapse-carded" class='collapse ' role="tabpanel" aria-labelledby="heading-carded" data-children=".nav-item">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link ripple " href="user-interface-page-layouts-carded-full-width.html" data-url="apps-contacts.html">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link ripple " href="user-interface-page-layouts-carded-full-width-2.html" data-url="apps-contacts.html">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link ripple " href="user-interface-page-layouts-carded-left-sidebar.html" data-url="apps-contacts.html">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link ripple " href="user-interface-page-layouts-carded-left-sidebar-2.html" data-url="apps-contacts.html">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link ripple " href="user-interface-page-layouts-carded-right-sidebar.html" data-url="apps-contacts.html">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link ripple " href="user-interface-page-layouts-carded-right-sidebar-2.html" data-url="apps-contacts.html">
                                    ...
                                    <li class="nav-item" role="tab" id="heading-simple">
                                        ...
                                        <ul id="collapse-simple" class='collapse ' role="tabpanel" aria-labelledby="heading-simple" data-children=".nav-item">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link ripple " href="user-interface-page-layouts-simple-full-width.html" data-url="apps-contacts.html">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link ripple " href="user-interface-page-layouts-simple-left-sidebar.html" data-url="apps-contacts.html">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link ripple " href="user-interface-page-layouts-simple-left-sidebar-2.html" data-url="apps-contacts.html">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link ripple " href="user-interface-page-layouts-simple-left-sidebar-inner.html" data-url="apps-contacts.html">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link ripple " href="user-interface-page-layouts-simple-left-sidebar-floating.html" data-url="apps-contacts.html">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link ripple " href="user-interface-page-layouts-simple-right-sidebar.html" data-url="apps-contacts.html">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link ripple " href="user-interface-page-layouts-simple-right-sidebar-2.html" data-url="apps-contacts.html">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link ripple " href="user-interface-page-layouts-simple-right-sidebar-inner.html" data-url="apps-contacts.html">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link ripple " href="user-interface-page-layouts-simple-right-sidebar-floating.html" data-url="apps-contacts.html">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link ripple " href="user-interface-page-layouts-simple-tabbed.html" data-url="apps-contacts.html">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="user-interface-page-layouts-blank.html" data-url="apps-contacts.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link ripple " href="user-interface-typography.html" data-url="apps-contacts.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link ripple " href="user-interface-icons.html" data-url="apps-contacts.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link ripple " href="user-interface-colors.html" data-url="apps-contacts.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link ripple " href="user-interface-helper-classes.html" data-url="apps-contacts.html">
                            ...
                            <li class="nav-item" role="tab" id="heading-charts">
                                ...
                                <ul id="collapse-charts" class='collapse ' role="tabpanel" aria-labelledby="heading-charts" data-children=".nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="components-charts-nvd3.html" data-url="apps-contacts.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link ripple " href="components-collapse.html" data-url="apps-contacts.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link ripple " href="components-modal.html" data-url="apps-contacts.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link ripple " href="components-popovers.html" data-url="apps-contacts.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link ripple " href="components-snackbar.html" data-url="apps-contacts.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link ripple " href="components-tooltips.html" data-url="apps-contacts.html">
                            ...
                            <div class="page-content p-4 p-sm-6">
                                ...
                                <div class="contacts-list card">
                                    ...
                                    <div class="contact-item ripple row no-gutters align-items-center py-2 px-3 py-sm-4 px-sm-6">
                                        ...
                                        <img class="avatar mx-4" alt="Arnold" src="../assets/images/avatars/Arnold.jpg" />
                                    ...
                                    <div class="contact-item ripple row no-gutters align-items-center py-2 px-3 py-sm-4 px-sm-6">
                                        ...
                                        <img class="avatar mx-4" alt="Christy" src="../assets/images/avatars/Christy.jpg" />
                                    ...
                                    <div class="contact-item ripple row no-gutters align-items-center py-2 px-3 py-sm-4 px-sm-6">
                                        ...
                                        <img class="avatar mx-4" alt="Copeland" src="../assets/images/avatars/Copeland.jpg" />
                                    ...
                                    <div class="contact-item ripple row no-gutters align-items-center py-2 px-3 py-sm-4 px-sm-6">
                                        ...
                                        <img class="avatar mx-4" alt="Harper" src="../assets/images/avatars/Harper.jpg" />
                                    ...
                                    <div class="contact-item ripple row no-gutters align-items-center py-2 px-3 py-sm-4 px-sm-6">
                                        ...
                                        <img class="avatar mx-4" alt="Henderson" src="../assets/images/avatars/Henderson.jpg" />
                                    ...
                                    <div class="contact-item ripple row no-gutters align-items-center py-2 px-3 py-sm-4 px-sm-6">
                                        ...
                                        <img class="avatar mx-4" alt="Josefina" src="../assets/images/avatars/Josefina.jpg" />
                                    ...
                                    <div class="contact-item ripple row no-gutters align-items-center py-2 px-3 py-sm-4 px-sm-6">
                                        ...
                                        <img class="avatar mx-4" alt="Katina" src="../assets/images/avatars/Katina.jpg" />
                                    ...
                                    <div class="contact-item ripple row no-gutters align-items-center py-2 px-3 py-sm-4 px-sm-6">
                                        ...
                                        <img class="avatar mx-4" alt="Odessa" src="../assets/images/avatars/Odessa.jpg" />
                                    ...
                                    <div class="contact-item ripple row no-gutters align-items-center py-2 px-3 py-sm-4 px-sm-6">
                                        ...
                                        <img class="avatar mx-4" alt="Shauna" src="../assets/images/avatars/Shauna.jpg" />
                                    ...
                                    <div class="contact-item ripple row no-gutters align-items-center py-2 px-3 py-sm-4 px-sm-6">
                                        ...
                                        <img class="avatar mx-4" alt="Shepard" src="../assets/images/avatars/Shepard.jpg" />
                                    ...
                                    <div class="contact-item ripple row no-gutters align-items-center py-2 px-3 py-sm-4 px-sm-6">
                                        ...
                                        <img class="avatar mx-4" alt="Tillman" src="../assets/images/avatars/Tillman.jpg" />
                                    ...
                                    <div class="contact-item ripple row no-gutters align-items-center py-2 px-3 py-sm-4 px-sm-6">
                                        ...
                                        <img class="avatar mx-4" alt="Trevino" src="../assets/images/avatars/Trevino.jpg" />
