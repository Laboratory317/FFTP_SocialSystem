...
function(){e(window).trigger(n,t)},300)}}(jQuery),
function(e){var n,t=!1;window.fuseBar=n={
instances:{},toggle:a,closeAll:d};
function i(e){return n.instances[e]}
function a(n){
var a=i(n);if(a.isActive){a.opened?o(n):(s=n,d().then(
function(){var n=i(s);n.el.css({transform:"translate3D(0,0,0)"}),
n.el.removeClass("fuse-bar-closed"),
n.el.addClass("fuse-bar-open"),
n.opened=!0,
(t=e('<div class="fuse-bar-backdrop fuse-bar-backdrop-'+s.replace(" ","-")+'"></div>')).hide(),
n.el.after(t),
t.fadeIn(),
